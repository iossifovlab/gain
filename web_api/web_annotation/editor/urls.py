...
urlpatterns = [
    ...
    re_path(
        r"api/editor/pipeline_attributes/?",
        views.PipelineAttributes.as_view(),
    ),
    re_path(
        r"api/editor/annotator_attributes/?",
        views.AnnotatorAttributes.as_view(),
    ),
    re_path(r"api/editor/annotator_yaml/?", views.AnnotatorYAML.as_view()),
    re_path(
        r"api/editor/resource_annotators/?",
