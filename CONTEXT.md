...
an exact run algebra fragments do not have, and no consumer question survives
that the fragment count and lengths cannot already answer (ADR 0020, amended
