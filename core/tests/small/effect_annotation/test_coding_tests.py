...
import pytest
from gain.effect_annotation.annotator import (
    AnnotationRequestFactory,
    EffectAnnotator,
    Variant,
)
from gain.effect_annotation.effect_checkers.coding import CodingEffectChecker
...
@pytest.fixture(scope="session")
def effect_checker() -> CodingEffectChecker:
