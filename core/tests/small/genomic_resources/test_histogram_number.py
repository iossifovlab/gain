...
def test_default_histogram_conf_for_a_number_has_no_view_range() -> None:
    conf = build_default_histogram_conf("float")

    assert conf == NumberHistogramConfig.default_config(None)
